...
class TSL2561(Sensor):
    ...
    def set_gain(self,gain=1):
        ...
        if gain != self.gain:
            ...
            time.sleep(self._pause)              # pause for integration (self.pause must be bigger than integration time)
    ...
    def readLux(self, gain = 0):
        ...
        return lux
	"""def __init__(self, controller, timeout=1, address=TSL2561_I2CADDR, bus=1, name="AL1"):
		super().__init__()
		self._controller = controller
		controller.register_sensor(self, name)
		self._timeout = timeout
